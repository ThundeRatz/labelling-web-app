...
(function() {
  ...
  BBoxSelector = (function() {
    ...
    BBoxSelector.prototype.crop = function(pageX, pageY) {
      ...
      return (point = {
        x: Math.min(
          Math.max(Math.round(pageX - this.image_frame.offset().left), 0),
          Math.round(this.image_frame.width() - 1)
        ),
        y: Math.min(
          Math.max(Math.round(pageY - this.image_frame.offset().top), 0),
  ...
  this.BBoxAnnotator = (function() {
    function BBoxAnnotator(options) {
      ...
      image_element.onload = function() {
        options.onload && options.onload(); // Added
        ...
        switch (status) {
          case 'hold':
            ...
            if (rectangle.width < 2 || rectangle.height < 2) {
              alert('Invalid rectangle: too small');
            } else {
